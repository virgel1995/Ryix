...
module.exports = class extends Language {
  constructor (...args) {
    ...
    this.language = {
      ...
      COMMAND_INFO: () => [
        "Ryix is a 'multi-purpose' discord bot built with Klasa and Discord.js.",
        '',
        'Features:',
        '• 🐇💨 Fast Discord Bot',
        '• 🎚🎛 Per-client/guild/user settings that can be extended with your own fields',
        '• ⏰ 80% uptime.',
        '• 🎵 "Music System", supports Youtube/Soundcloud/Twitch',
        '',
        'Add Ryix to your server and say `r?help`.'
      ],
